...
class TMugastPhysics : public TObject, public NPL::VDetector {
  ...
  //int NumberofRing;
  vector<int> NumberofRing;
  //int NumberofSector;
  vector<int> NumberofSector;
  int AddTelescopeCycles = 0;
 ...
 //   Special Method for Annular S1
  ...
  //void AddTelescope(MG_DetectorType type,TVector3 C_Center,double Thickness, int NumberofRing, int NumberofSector);
  ...
  double GetSiliconThickness(){
    return SiliconThickness;
  };
  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
