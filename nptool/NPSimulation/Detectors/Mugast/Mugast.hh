...
class Mugast : public NPS::VDetector{
  ...
  private:
    ...
    G4LogicalVolume* m_AnnularDetectorBack;
  ...
  public:   // Scorer
    ...
    G4MultiFunctionalDetector* m_AnnularScorerBack;
    ////////////////////////////////////////////////////
  ...
  private: // Geometry
    ...
    bool firstStagePassed = false;
    int stage = 0;
    double SiliconThickness;
    vector<double> WaferThickness;
    //int NbrRingStrips;
    vector<int> NbrRingStrips;
    //int NbrSectorStrips;
    vector<int> NbrSectorStrips;

    bool FrontStrips[128] = {false};
