...
//    cout << "EnergyX = " << Energy
//         << " \t ADC = " << NPL::EnergyToADC(Energy, 0, 127, 16384, 32768)
//         << endl;
...
//cout << "Strip# Front = " << StripFront << endl;
//FrontStrips[StripFront-1] = true;

//for(int s=0; s<128; s++){
//  cout << s << "\t" << FrontStrips[s] << endl;
//}
      ...
      //StripFront = StripFront + StripQuadrant * NbrRingStrips[DetNbr-10];
...
//    cout << "EnergyY = " << Energy 
//	 << " \t ADC = " << NPL::EnergyToADC(Energy, 0, 127, 16384, 0) 
//	 << endl;
...
//cout << "Strip# Back = " << StripBack << endl;
...
void Mugast::InitializeScorers() {
  ...
  G4VPrimitiveScorer* AnnularScorer =
      new DSSDScorers::PS_Annular("MugastAnnularScorer", 2, ActiveWaferInnerRadius, ActiveWaferOutterRadius,
                                  ...
                                  //+8 * 22.5 * deg, NbrRingStrips[DetNbr-10], NbrSectorStrips[DetNbr-10], NbQuadrant);
